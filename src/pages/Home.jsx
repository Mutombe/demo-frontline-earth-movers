      ...
      {[...Array(14)].map((_, i) => (
        <div
          ...
          style={{
            ...
            height: '1px',
            background: `linear-gradient(90deg, transparent, rgba(249,115,22,${Math.random() * 0.35 + 0.1}), transparent)`,
            left: `${Math.random() * 100}%`,
            top: `${Math.random() * 100}%`,
            animation: `orange-streak ${Math.random() * 4 + 3}s linear infinite`,
...
function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      <div className="absolute top-[10%] left-0 w-[3px] h-40 sm:h-56 bg-gradient-to-b from-transparent via-orange-500 to-transparent z-20" />
      ...
      >
        ...
        <motion.div
          ...
          className="w-20 h-[3px] bg-gradient-to-r from-orange-500 to-orange-400/50 mb-6 origin-left"
        />
        ...
        <div className="overflow-hidden">
          {['FRONTLINE', 'EARTH', 'MOVERS.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                className={`font-heading leading-[0.92] tracking-tight ${
                  line === 'EARTH'
                    ? 'bg-gradient-to-r from-orange-500 via-orange-400 to-amber-400 bg-clip-text text-transparent'
                    : 'text-white'
                }`}
                style={{
                  fontSize: 'clamp(2.2rem, 7vw, 4.5rem)',
                  fontWeight: line === 'EARTH' ? 700 : 300,
                }}
              >
                {line}
              </h1>
        ...
        >
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 bg-orange-500 text-navy-950 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-orange-400 hover:shadow-xl hover:shadow-orange-500/20"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaPrimary}
...
function RouteTrackingStrip() {
  const routes = ['HARARE', 'NORTON', 'CHINHOYI', 'KARIBA', 'BINDURA', 'MARONDERA', 'KADOMA', 'KWEKWE', 'GWERU'];
      ...
      <div className="animate-marquee flex whitespace-nowrap">
        {repeated.map((item, i) => (
          <span key={i} className="flex items-center gap-6 sm:gap-8 mx-6 sm:mx-8">
            <span className="text-orange-500/80 font-heading text-lg sm:text-2xl tracking-wider uppercase font-semibold">
              {item}
            </span>
            <NavigationArrow size={14} weight="fill" className="text-orange-500/20 rotate-90" />
          </span>
        ))}
      </div>
    </section>
  ...
  return (
    <section ref={ref} className="bg-navy-900 py-24 sm:py-32 lg:py-40">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          <div className="w-12 h-[3px] bg-orange-500 mb-6" />
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              <p className="text-orange-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Our Capabilities</p>
              <h2 className="font-heading text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 4.5vw, 3.5rem)' }}>
                Heavy <span className="text-orange-500">Equipment</span>
              </h2>
            </div>
            <Link
              to="/services"
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 right-5 z-10">
                    <span className="text-orange-500/10 font-heading text-6xl sm:text-7xl leading-none font-bold">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                  </div>

                  {/* Green icon badge — filled */}
                  <div className="absolute top-5 left-5 z-10 w-10 h-10 bg-orange-500/20 border border-orange-500/30 flex items-center justify-center group-hover:bg-orange-500/30 group-hover:border-orange-500/60 transition-all duration-500">
                    <IconComp size={18} weight="fill" className="text-orange-400" />
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-orange-500 to-amber-400 z-10" />
                </Link>
              </motion.div>
            );
          })}
    ...
    <section ref={containerRef} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        ...
        >
          <div>
            <div className="w-12 h-[3px] bg-orange-500 mb-6" />
            <p className="text-orange-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Recent Projects</p>
            <h2 className="font-heading text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)' }}>
              Projects <span className="text-orange-500">Completed</span>
            </h2>
          </div>
          <Link
            to="/projects"
            ...
            >
              <div className="aspect-[3/4] overflow-hidden relative">
                ...
                <div className="absolute top-5 left-5 z-10">
                  <span className="bg-orange-500/90 text-navy-950 text-[10px] uppercase tracking-[0.2em] px-3 py-1.5 font-semibold" style={{ fontFamily: 'var(--font-sans)' }}>
                    {project.category}
                  </span>
                </div>
              </div>
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-20 sm:py-24">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-16">
          {stats.map((stat, i) => (
            ...
            >
              <div
                className="font-heading text-orange-500 leading-none font-bold"
                style={{ fontSize: 'clamp(2.8rem, 6vw, 5rem)', textShadow: '0 0 40px rgba(249,115,22,0.15)' }}
              >
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-orange-500 font-heading text-3xl sm:text-4xl leading-none font-bold">{business.established}</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Founded</div>
              </div>
              <div>
                <div className="text-orange-500 font-heading text-3xl sm:text-4xl leading-none font-bold">{business.projectsCompleted}</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Deliveries</div>
              </div>
              <div>
                <div className="text-orange-500 font-heading text-3xl sm:text-4xl leading-none font-bold">99%</div>
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-orange-500 text-navy-950 p-5 sm:p-7 shadow-2xl">
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Modern Fleet', desc: 'Excavators, loaders, graders, and dump trucks maintained to the highest standards.' },
    { title: 'Experienced Operators', desc: 'Every operator is certified and has 5+ years of heavy machinery experience.' },
    { title: 'Flexible Hire Terms', desc: 'Daily, weekly, or project-based hire. We work around your schedule.' },
    { title: 'Safety First', desc: 'Full PPE compliance, site risk assessments, and insurance on every job.' },
  ];
    ...
    <section ref={ref} className="bg-navy-900 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <div className="w-12 h-[3px] bg-orange-500 mb-6" />
            <p className="text-orange-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>The Advantage</p>
              ...
              <div className="flex flex-col items-center gap-3">
                {t.avatar && (
                  <img
                    src={t.avatar}
                    alt={t.name}
                    className="w-12 h-12 rounded-full object-cover object-center border-2 border-orange-500/30"
                    loading="lazy"
                  />
                )}
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        ...
        >
          <div className="w-16 h-[3px] bg-orange-500 mx-auto mb-8" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              className="group relative inline-flex items-center gap-3 bg-orange-500 text-navy-950 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-orange-400 hover:shadow-xl hover:shadow-orange-500/25"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
            ...
            <a
              ...
              className="group inline-flex items-center gap-3 border border-orange-500/40 text-orange-400 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-orange-500/10 hover:border-orange-500/60"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
