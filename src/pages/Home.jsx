...
/* ================================================================
   DECORATIVE PARTICLES — floating geometric shapes
   ================================================================ */
      ...
      {[...Array(15)].map((_, i) => (
        <div
          ...
          style={{
            ...
            background: `radial-gradient(circle, rgba(34,197,94,${Math.random() * 0.5 + 0.15}) 0%, transparent 70%)`,
...
function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
        ...
        {heroImages.map((_, i) => (
          <button
            ...
            className={`w-[3px] transition-all duration-700 ${
              i === currentSlide ? 'h-10 bg-green-500' : 'h-4 bg-white/20 hover:bg-white/40'
            }`}
      ...
      <div className="absolute top-[15%] left-0 w-[2px] h-32 sm:h-48 bg-gradient-to-b from-transparent via-green-500 to-transparent z-20" />
      ...
      >
        ...
        <motion.div
          ...
          className="w-16 h-[2px] bg-gradient-to-r from-green-500 to-green-400/50 mb-6 origin-left"
        />
        ...
        <motion.p
          ...
          className="text-green-400 text-xs sm:text-sm font-semibold uppercase tracking-[0.3em] mb-8"
        ...
        <div className="overflow-hidden">
          {['WE MOVE', 'MOUNTAINS', 'SO YOU CAN BUILD.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
            ...
            >
              <h1
                className={`font-heading leading-[0.92] tracking-tight ${
                  line === 'MOUNTAINS'
                    ? 'bg-gradient-to-r from-green-500 via-green-400 to-emerald-500 bg-clip-text text-transparent italic'
                    : 'text-white'
                }`}
                style={{
                  fontSize: 'clamp(2.2rem, 7vw, 4.5rem)',
                  fontWeight: line === 'MOUNTAINS' ? 700 : 300,
                }}
              >
                {line}
              </h1>
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            300+ Projects &middot; 45+ Fleet &middot; Est. 2015
          </p>
        </motion.div>
        ...
        >
          <Link
            to="/contact"
            className="group relative inline-flex items-center gap-3 bg-green-600 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-green-500 hover:shadow-xl hover:shadow-green-500/20"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaPrimary}
          ...
          <Link
            to="/projects"
            className="group inline-flex items-center gap-3 border border-white/20 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:border-green-500/50 hover:text-green-400 hover:bg-white/5"
            style={{ fontFamily: 'var(--font-sans)' }}
          >
            {hero.ctaSecondary}
          </Link>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Frontline &mdash; Harare &middot; Nationwide &middot; Cross-Border
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['HEAVY HAULAGE', 'EARTHMOVING', 'FLEET LOGISTICS', 'SITE CLEARING', 'TIPPER HIRE', 'PLANT HIRE'];
      ...
      <div className="animate-marquee flex whitespace-nowrap">
        {repeated.map((item, i) => (
          <span key={i} className="flex items-center gap-6 sm:gap-8 mx-6 sm:mx-8">
            <span className="text-green-500/80 font-heading text-lg sm:text-2xl italic tracking-wider">
              {item}
            </span>
            <span className="text-green-500/20 text-sm">&diams;</span>
          </span>
        ))}
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              <p className="text-green-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>What We Do</p>
              <h2 className="font-heading text-white leading-[0.92] italic" style={{ fontSize: 'clamp(2rem, 4.5vw, 3.5rem)' }}>
                Our <span className="text-green-500">Capabilities</span>
              </h2>
            </div>
            <Link
              to="/services"
              className="group text-white/30 text-xs uppercase tracking-[0.2em] flex items-center gap-2 hover:text-green-500 transition-colors"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
              All Services
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 right-5 z-10">
                    <span className="text-green-500/15 font-heading text-6xl sm:text-7xl italic leading-none">
                      {String(i + 1).padStart(2, '0')}
                    </span>
                  </div>

                  {/* Icon badge */}
                  <div className="absolute top-5 left-5 z-10 w-10 h-10 border border-green-500/30 flex items-center justify-center bg-navy-950/60 backdrop-blur-sm group-hover:bg-green-500/20 group-hover:border-green-500/60 transition-all duration-500">
                    <IconComp size={18} weight="light" className="text-green-500" />
                  </div>
    ...
    <section ref={containerRef} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        ...
        >
          <div>
            <div className="w-12 h-[2px] bg-green-500 mb-6" />
            <p className="text-green-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Selected Works</p>
            ...
            >
              <div className="aspect-[3/4] overflow-hidden relative">
                ...
                <div className="absolute top-5 left-5 z-10">
                  <span className="bg-green-600/90 text-white text-[10px] uppercase tracking-[0.2em] px-3 py-1.5 font-semibold" style={{ fontFamily: 'var(--font-sans)' }}>
                    {project.category}
                  </span>
                </div>
              </div>
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-20 sm:py-24">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-16">
          {stats.map((stat, i) => (
            ...
            >
              <div
                className="font-heading text-green-500 leading-none italic"
    ...
    <section ref={ref} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="w-12 h-[2px] bg-green-500 mb-6" />
            <p className="text-green-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Our Story</p>
            <h2 className="font-heading text-white leading-[0.95] italic mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
              Built From<br />
              <span className="text-green-500">The Ground Up</span>
            </h2>
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Founded in 2015 with a single tipper truck and a commitment to reliability, Frontline Earth Movers has grown into one of Harare's most trusted logistics and earthmoving companies.
            </p>
            <p className="text-white/35 text-sm leading-relaxed max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Today, with a fleet of over 45 vehicles and a team of experienced operators, we serve Zimbabwe's construction, mining, and infrastructure sectors. Our growth has been driven entirely by repeat business -- the highest compliment in our industry.
            </p>
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-green-500 font-heading text-3xl sm:text-4xl italic leading-none">2015</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Founded</div>
              </div>
              <div>
                <div className="text-green-500 font-heading text-3xl sm:text-4xl italic leading-none">300+</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Projects</div>
              </div>
              <div>
                <div className="text-green-500 font-heading text-3xl sm:text-4xl italic leading-none">45+</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Fleet</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-green-600 text-white p-5 sm:p-7 shadow-2xl">
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'On-Time, Every Time', desc: 'Delays cost money. We plan meticulously, deploy reliably, and deliver on schedule without fail.' },
    ...
    <section ref={ref} className="bg-navy-900 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <div className="w-12 h-[2px] bg-green-500 mb-6" />
            <p className="text-green-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>The Difference</p>
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-green-500">Frontline</span>
            </h2>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
              ...
              <div className="flex flex-col items-center gap-3">
                {t.avatar && (
                  <img
                    src={t.avatar}
                    alt={t.name}
                    className="w-12 h-12 rounded-full object-cover object-center border-2 border-green-500/30"
                    loading="lazy"
                  />
                )}
          ...
          <div className="flex items-center justify-center gap-6 mt-12">
            <button
              onClick={prev}
              className="w-10 h-10 border border-white/10 flex items-center justify-center text-white/30 hover:text-green-500 hover:border-green-500/30 transition-colors duration-300"
              ...
              {homeTestimonials.map((_, i) => (
                <button
                  ...
                  className={`h-[2px] transition-all duration-500 ${
                    i === active ? 'w-10 bg-green-500' : 'w-3 bg-white/10 hover:bg-white/25'
                  }`}
    ...
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        ...
        >
          ...
          >
            YOUR PROJECT<br />
            <span className="text-green-500">OUR MUSCLE</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/contact"
              className="group relative inline-flex items-center gap-3 bg-green-600 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-green-500 hover:shadow-xl hover:shadow-green-500/25"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
              {homeCta.ctaPrimary}
              <ArrowRight size={16} className="transition-transform group-hover:translate-x-1" />
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center gap-6 text-xs text-white/25 uppercase tracking-[0.15em]" style={{ fontFamily: 'var(--font-sans)' }}>
            <a href={`tel:${business.phoneRaw}`} className="flex items-center gap-2 hover:text-green-500 transition-colors">
              <Phone size={14} /> {business.phone}
            </a>
            <span className="hidden sm:inline text-white/10">|</span>
            <a href={`mailto:${business.email}`} className="hover:text-green-500 transition-colors">
              {business.email}
            </a>
            <span className="hidden sm:inline text-white/10">|</span>
